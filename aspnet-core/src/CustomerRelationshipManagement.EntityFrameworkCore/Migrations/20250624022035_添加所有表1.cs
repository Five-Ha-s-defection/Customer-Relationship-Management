...
{
    /// <inheritdoc />
    public partial class 添加所有表1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivableCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceivablePay = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000000"), "", "82820a20ca464e7bbf7023f716825fbd", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "admin@admin.com", "{}", true, null, null, "123", "12345678901", "", "admin" });
