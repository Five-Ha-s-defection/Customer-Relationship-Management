...
using CustomerRelationshipManagement.CustomerProcess.ProcessManegement.ContactCommunications;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.ClueSources;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.ContactRelations;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.CustomerContacts;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.CustomerLevels;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.CustomerRegions;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.Customers;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.CustomerTypes;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.Industrys;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.Prioritys;
using CustomerRelationshipManagement.CustomerProcess.CustomerManegement.SalesProgresses;
