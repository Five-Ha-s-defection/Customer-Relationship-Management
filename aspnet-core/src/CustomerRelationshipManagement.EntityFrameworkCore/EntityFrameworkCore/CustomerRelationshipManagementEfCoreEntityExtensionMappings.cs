...
public static class CustomerRelationshipManagementEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE CustomerRelationshipManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
