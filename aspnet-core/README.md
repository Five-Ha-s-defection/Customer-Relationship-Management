...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 46d57c2d-1043-4169-934e-b2419ccb5efb
```

> `46d57c2d-1043-4169-934e-b2419ccb5efb` is the password of the certificate, you can change it to any password you want.
...
Run `CustomerRelationshipManagement.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.

### Solution structure

This is a layered monolith application that consists of the following applications:

* `CustomerRelationshipManagement.DbMigrator`: A console application which applies the migrations and also seeds the initial data. It is useful on development as well as on production environment.
